...
//
//					case "float" -> {
//						field.setFloat(this, annotation.Float() / tickrate);
//					}
//					case "double" -> {
//						field.setDouble(this, annotation.Double() / tickrate);
//					}
//
//					case "byte" -> {
//						field.setByte(this, (byte) (annotation.Byte() / tickrate));
//					}
//					case "short" -> {
//						field.setShort(this, (short) (annotation.Short() / tickrate));
//					}
//					case "int" -> {
//						field.setInt(this, annotation.Integer() / tickrate);
//					}
//					case "long" -> {
//						field.setLong(this, (long) (annotation.Long() / tickrate));
//					}
//
//					}
//				}
...
//		} catch (Exception e) {
//			System.err
//					.println("Настройка тикрейтозависимых элементов провалилась на типе " + this.getClass().getName());
